...
var centerMenu = [
    ...
    ,{
        name: '水果收藏',
        url: '../shuiguoCollection/list.html'
    }
    ,{
        name: '水果订单',
        url: '../shuiguoOrder/list.html'
    }
...
var adminurl =  "http://localhost:8080/shuiguozaixianxiaoshou/admin/dist/index.html#/login";
