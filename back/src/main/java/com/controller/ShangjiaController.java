...
//                            shangjiaEntity.setShangjiaYesnoTypes(Integer.valueOf(data.get(0)));   //审核状态 要改的
//                            shangjiaEntity.setShangjiaYesnoText(data.get(0));                    //审核意见 要改的
//                            shangjiaEntity.setShangjiaShenheTime(sdf.parse(data.get(0)));          //审核时间 要改的
