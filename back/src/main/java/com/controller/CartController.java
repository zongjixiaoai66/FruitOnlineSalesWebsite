    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(cart !=null){
            ...
            BeanUtils.copyProperties( cart , view );//把实体数据重构到view中
                ...
                //级联表
                ShuiguoEntity shuiguo = shuiguoService.selectById(cart.getShuiguoId());
                if(shuiguo != null){
    ...
    */
    ...
    public R save(@RequestBody CartEntity cart, HttpServletRequest request){
        ...
        Wrapper<CartEntity> queryWrapper = new EntityWrapper<CartEntity>()
            ...
            .eq("shuiguo_id", cart.getShuiguoId())
...
//                            cartEntity.setShuiguoId(Integer.valueOf(data.get(0)));   //水果 要改的
