...
public class ShuiguoCommentbackView extends ShuiguoCommentbackEntity implements Serializable {
	...
	public ShuiguoCommentbackView() {

	}

	public ShuiguoCommentbackView(ShuiguoCommentbackEntity shuiguoCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, shuiguoCommentbackEntity);
