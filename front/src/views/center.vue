  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='shangjia'"  label='审核状态' prop="shangjiaYesnoTypes">
                 <el-select v-model="ruleForm.shangjiaYesnoTypes" disabled  placeholder='请选择审核状态'>
                     <el-option
                             v-for="(item,index) in shangjiaYesnoTypesOptions"
                             v-bind:key="item.codeIndex"
                             :label="item.indexName"
                             :value="item.codeIndex">l
                     </el-option>
                 </el-select>
             </el-form-item>
         </el-col>
         <!--<el-col :span="12">
           <el-form-item v-if="flag=='shangjia'"  label='审核意见' prop="shangjiaYesnoText">
               <el-input v-model="ruleForm.shangjiaYesnoText"  placeholder='审核意见' clearable></el-input>
           </el-form-item>
         </el-col>-->
...
// 注册表 商家 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.shangjiaYesnoText)&& 'shangjia'==this.flag){
