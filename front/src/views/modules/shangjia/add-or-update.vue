        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="商家信用类型" prop="shangjiaXingjiTypes">
                        <el-select v-model="ruleForm.shangjiaXingjiTypes" :disabled="ro.shangjiaXingjiTypes" placeholder="请选择商家信用类型">
                            <el-option
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.shangjiaYesnoTypes" label="审核状态" prop="shangjiaYesnoTypes">
                        <el-input v-model="ruleForm.shangjiaYesnoValue" placeholder="审核状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.shangjiaYesnoText" label="审核意见" prop="shangjiaYesnoText">
                        <span v-html="ruleForm.shangjiaYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.shangjiaShenheTime" label="审核时间" prop="shangjiaShenheTime">
                        <span v-html="ruleForm.shangjiaShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    shangjiaYesnoTypes: false,
                    shangjiaYesnoText: false,
                    shangjiaShenheTime: false,
                ...
                rules: {
                   ...
                   shangjiaXingjiTypes: [
                              { required: true, message: '商家信用类型不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
